  ...
  return (
    ...
    <div className="container-fluid table-responsive" id="admin-comp">
      <div className="row">
        ...
        <div class="card-img-overlay">
          <div className="card-body">
            <div class="card-text-center" id="bottom" ><strong>USER REGISTRATION</strong></div>
        ...
        <div class="card-img-overlay">
          <div className="card-body">
          <div class="card-text-center" id="bottom" ><strong>USER DATABASE</strong></div>
        ...
        <div class="card-img-overlay">
          <div className="card-body">
          <div class="card-text-center" id="bottom" ><strong>ADD SHIPMEMT</strong></div>
      ...
      <div className="row">
        ...
        <div class="card-img-overlay">
          <div className="card-body">
          <div class="card-text-center" id="bottom" ><strong>WAREHOUSES</strong></div>
        ...
        <div className="card" id="link_card">
        <img class="card-img-top" src={image7} alt="Card image cap"/>
        <div class="card-img-overlay">
          <div className="card-body">
          <div class="card-text-center" id="bottom" ><strong>ADD WAREHOUSE</strong></div>
        ...
        <div className="card" id="link_card">
        <img class="card-img-top" src={image8} alt="Card image cap"/>
        <div class="card-img-overlay">
          <div className="card-body">
        ...
        <div className="card" id="link_card">
        <img class="card-img-top" src={image9} alt="Card image cap"/>
        <div class="card-img-overlay">
          <div className="card-body">
          <div class="card-text-center" id="bottom" ><strong>CREATE ASSET</strong></div>
